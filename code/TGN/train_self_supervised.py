...
parser.add_argument('--val_time', type=float, default=-1, help='End time of the training phase')
...
new_node_test_data = get_data(DATA,
                              ...
                              randomize_features=args.randomize_features, val_time_data=args.val_time)
...
#----------------------------------------------------------------------------------------------------
        #negatives_batch, _ = train_rand_sampler.select_neg(sources_batch, timestamps_batch, NUM_NEIGHBORS, train_ngh_finder, tgn.memory)
#----------------------------------------------------------------------------------------------------
        with torch.no_grad():
        ...
        if len(pos_prob.squeeze().size()) == 0:
